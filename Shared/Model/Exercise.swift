...
class Exercise: Alphabetizable {
    ...
    init(name: String, note: String? = nil, exerciseDescription: String? = nil, imageString: String? = nil, muscleType: MuscleType, secondaryMuscleTypes: [MuscleType] = [], equipmentType: EquipmentType, exerciseType: ExerciseType, previousSets: [ExerciseSet] = []) {
        self.name = name
        self.note = note
